...
with tab3:
    ...
    if feat_dep in feature_names:
        ...
        st.caption(f"***pct_cambio_logins:*** % de cambio en los logins (uso) de un usuario entre dos periodos; mide cómo cambió la actividad del usuario: (logins_actual - logins_previos) / logins_previos")
